        ...
        },
        {
            ...
            render: (text, record) => (<Link to={{
                ...
                state: {
                    ...
                    action: "Approval",
                    disable: false,
                    linkBack: "/instructionManagement/approval",
                }
    ...
    const [data] = useState([
        {
            ...
            key: '1',
            refNo: 'AM200709.0001',
            task: ["Security Management", <br />, "CENAIDJA - Bank Central Asia (BCA)"],
            lastUpdate: '08-07-2020',
            updatedBy: 'fulan',
            status: 'Waiting for Checker',
            linkTo: '/instructionManagement/approvalInstructionDetail',
        ...
        },
        {
            ...
            key: '2',
            refNo: 'AM200709.0002',
            task: ["Cash Management", <br />, "CENAIDJA - Bank Central Asia (BCA)"],
            lastUpdate: '08-07-2020',
            updatedBy: 'fulan',
...
export default ApprovalInstruction
