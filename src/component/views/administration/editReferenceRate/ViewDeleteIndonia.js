...
const ViewDeleteIndonia = (props) => {
    ...
    const [indonia, setIndonia] = useState({
        date: "test",
        value: null,
        update: null,
        note: null,
    ...
    const submitDelete = () => {
        axios.delete(`http://localhost:8080/referenceindonias/${idx}`, {
        })
            .then(res => {
                console.log(res);
    ...
    return (
        <div>
            ...
            <Descriptions column={1} bordered
                ...
                <Descriptions.Item label="Date">{indonia.date}</Descriptions.Item>
                <Descriptions.Item label="indONIA">{indonia.value}</Descriptions.Item>
            </Descriptions>
