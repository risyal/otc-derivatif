...
const OtherLink = [
    ...
    {
        useFor: 'editreferencerate',
        name: 'Add Data JIBOR',
        key: 'addDataJibor',
        useIn: 'adddatajibor',
        linkTo: rootWithNavLink + '/editreferencerate/add-data-jibor',
        component: ViewEditJibor,
    },
    {
        useFor: 'editreferencerate',
        name: 'Edit Data JIBOR',
        key: 'editDataJibor',
        useIn: 'editdatajibor',
        linkTo: rootWithNavLink + '/editreferencerate/edit-data-jibor',
        component: ViewEditJibor,
    },
    {
        useFor: 'editreferencerate',
        name: 'Delete Data JIBOR',
        key: 'deleteDataJibor',
        useIn: 'deletedatajibor',
        linkTo: rootWithNavLink + '/editreferencerate/delete-data-jibor',
        component: ViewDeleteJibor,
    },
    {
        useFor: 'editreferencerate',
        name: 'Add Data JISDOR',
        key: 'addDataJisdor',
        useIn: 'adddatajisdor',
        linkTo: rootWithNavLink + '/editreferencerate/add-data-jisdor',
        component: ViewEditJisdor,
    },
    {
        useFor: 'editreferencerate',
        name: 'Edit Data JISDOR',
        key: 'editDataJisdor',
        useIn: 'editdatajisdor',
        linkTo: rootWithNavLink + '/editreferencerate/edit-data-jisdor',
        component: ViewEditJisdor,
    },
    {
        useFor: 'editreferencerate',
        name: 'Delete Data JISDOR',
        key: 'deleteDataJisdor',
        useIn: 'deletedatajisdor',
        linkTo: rootWithNavLink + '/editreferencerate/delete-data-jisdor',
        component: ViewDeleteJisdor,
    },
    {
        useFor: 'editreferencerate',
        name: 'Add Data INDONIA',
        key: 'addDataIndonia',
        useIn: 'adddataindonia',
        linkTo: rootWithNavLink + '/editreferencerate/add-data-indonia',
        component: ViewEditIndonia,
    },
    {
        useFor: 'editreferencerate',
        name: 'Edit Data INDONIA',
        key: 'editDataIndonia',
        useIn: 'editdataindonia',
        linkTo: rootWithNavLink + '/editreferencerate/edit-data-indonia',
        component: ViewEditIndonia,
    },
    {
        useFor: 'editreferencerate',
        name: 'Delete Data INDONIA',
        key: 'deleteDataIndonia',
        useIn: 'deletedataindonia',
        linkTo: rootWithNavLink + '/editreferencerate/delete-data-indonia',
